...
# Read data from file
with open('/home/manolis/Downloads/AdvancedArch/advcomparch-ex2-helpcode/results/4_2_i', 'r') as file:
...
# Save plot
plt.savefig("/home/manolis/Downloads/AdvancedArch/advcomparch-ex2-helpcode/graphs/4.2/graph_i.png", bbox_inches="tight")
