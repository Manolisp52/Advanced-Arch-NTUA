...
# Read data from file
with open('/home/manolis/Downloads/AdvancedArch/advcomparch-ex2-helpcode/results/4_2_ii', 'r') as file:
...
plt.title('Mean MPKI for Different N-Bit Predictors')
plt.grid(True)
plt.tight_layout()

# Save plot
plt.savefig("/home/manolis/Downloads/AdvancedArch/advcomparch-ex2-helpcode/graphs/4.2/graph_ii.png", bbox_inches="tight")
