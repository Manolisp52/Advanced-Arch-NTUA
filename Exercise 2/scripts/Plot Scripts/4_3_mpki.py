...
# Read data from file
with open('/home/manolis/Downloads/AdvancedArch/advcomparch-ex2-helpcode/results/4_3_mean_mpki', 'r') as file:
...
plt.title('Mean Direction MPKI for Different BTB Predictors')
plt.grid(True)
plt.tight_layout()

# Save plot
plt.savefig("/home/manolis/Downloads/AdvancedArch/advcomparch-ex2-helpcode/graphs/4.3/graph_mpki.png", bbox_inches="tight")
