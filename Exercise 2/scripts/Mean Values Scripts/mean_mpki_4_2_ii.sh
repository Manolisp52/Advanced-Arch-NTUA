...
input_directory="/home/manolis/Downloads/AdvancedArch/advcomparch-ex2-helpcode/outputs/4.2/ii"
...
results_file="$output_directory/4_2_ii"
...
for file in "$input_directory"/*; do
    ...
    grep "Branch Predictors:" -A 4 "$file" | grep -v "Branch Predictors:" | while read line; do
