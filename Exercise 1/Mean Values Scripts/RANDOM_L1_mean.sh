...
directory="/home/manolis/Downloads/AdvancedArch/parsec-3.0-core/parsec-3.0/parsec_workspace/outputs/Random_L1"

RESULTS_DIR="/home/manolis/Downloads/AdvancedArch/parsec-3.0-core/parsec-3.0/parsec_workspace/results"
RANDOM_L1_DIR="$RESULTS_DIR/Random_L1"
...
# Check if the RANDOM_L1_DIR exists, if not, create it
if [ ! -d "$RANDOM_L1_DIR" ]; then
    mkdir -p "$RANDOM_L1_DIR"
    echo "Created RANDOM_L1_DIR: $RANDOM_L1_DIR"
fi

cd /home/manolis/Downloads/AdvancedArch/parsec-3.0-core/parsec-3.0/parsec_workspace/results/Random_L1
