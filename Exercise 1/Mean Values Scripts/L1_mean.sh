...
directory="/home/manolis/Downloads/AdvancedArch/parsec-3.0-core/parsec-3.0/parsec_workspace/outputs/L1"
...
# Check if the L1_DIR exists, if not, create it
if [ ! -d "$L1_DIR" ]; then
    mkdir -p "$L1_DIR"
    echo "Created L1_DIR: $L1_DIR"
fi

cd /home/manolis/Downloads/AdvancedArch/parsec-3.0-core/parsec-3.0/parsec_workspace/results/L1


base_l1_size=32
base_l1_associativity=4
