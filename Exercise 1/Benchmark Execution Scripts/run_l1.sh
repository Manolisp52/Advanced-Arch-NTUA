...
CMDS_FILE=./cmds_simlarge.txt # you have to copy the cmds_simlarge.txt to parsec_workspace
outDir="./outputs/" #you have to run the script inside the parsec_workspace folder
